...
Q_CONSTINIT static const qt_meta_stringdata_CLASSCropFeatureENDCLASS_t qt_meta_stringdata_CLASSCropFeatureENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(74, 12),  // "rotatedImage"
        QT_MOC_LITERAL(87, 8),  // "rotation"
        QT_MOC_LITERAL(96, 15),  // "transformOrigin"
        QT_MOC_LITERAL(112, 19)   // "setPreviousPosition"
    },
    "CropFeature",
    "previousPositionChanged",
    "",
...
void CropFeature::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->rotatedImage((*reinterpret_cast< std::add_pointer_t<QPixmap>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<qreal>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<QPointF>>(_a[3]))); break;
        case 3: _t->setPreviousPosition((*reinterpret_cast< std::add_pointer_t<QPointF>>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (CropFeature::*)(const QPixmap & , qreal , QPointF );
            if (_t _q_method = &CropFeature::rotatedImage; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 2
void CropFeature::rotatedImage(const QPixmap & _t1, qreal _t2, QPointF _t3)
{
